...
describe("document", () => {
  describe("matchDocument", () => {
    const TEST_DOCUMENTS = [
      ...
      [
        { request: {}, url: { hostname: "app.physica.finance", pathname: "" } },
        false,
      ],
      [
        {
          request: { mode: "navigate" },
          url: { hostname: "app.physica.finance", pathname: "" },
        },
        true,
      ],
      [
        {
          request: { mode: "navigate" },
          url: { hostname: "app.physica.finance", pathname: "/#/swap" },
        },
        true,
      ],
      [
        {
          request: { mode: "navigate" },
          url: { hostname: "app.physica.finance", pathname: "/asset.gif" },
        },
        false,
      ],
    ...
    it.each(TEST_DOCUMENTS)(
      "%j",
      (document: RouteMatchCallbackOptions, expected: boolean) => {
        jest
          .spyOn(window, "location", "get")
          .mockReturnValue({ hostname: document.url.hostname } as Location);
