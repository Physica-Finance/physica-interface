...
describe('document', () => {
  describe('matchDocument', () => {
    const TEST_DOCUMENTS = [
      ...
      [{ request: {}, url: { hostname: 'app.physica.finance', pathname: '' } }, false],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.physica.finance', pathname: '' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.physica.finance', pathname: '/#/swap' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.physica.finance', pathname: '/asset.gif' } }, false],
