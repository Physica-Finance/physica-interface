PhysicaTokenFactory__factory.ts/* Autogenerated file. Do not edit manually. */
/* tslint:disable */
/* eslint-disable */
...
interface PhysicaTokenFactoryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "createToken(string,string,bytes32,uint8,uint8)": FunctionFragment;
    ...
    "setInitialSupply(uint256)": FunctionFragment;
    "setMigrationCap(uint256)": FunctionFragment;
    "setPoolCreationFee(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setMigrationCap",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "setPoolCreationFee",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export type LaunchEvent = TypedEvent<[string] & { tokenAddress: string }>;
...
export class PhysicaTokenFactory extends BaseContract {
  ...
  functions: {
    ...
    migrationCap(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    setInitialSupply(
      _newInitialSupply: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    setMigrationCap(
      _newMigrationCap: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    setPoolCreationFee(
      _newPoolCreationFee: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  populateTransaction: {
    ...
    migrationCap(overrides?: CallOverrides): Promise<PopulatedTransaction>;
