...
export function useAllV3TicksQuery(
  ...
  return Apollo.useQuery<AllV3TicksQuery, AllV3TicksQueryVariables>(
    AllV3TicksDocument,
    options
  );
}
...
export type AllV3TicksLazyQueryHookResult = ReturnType<
  typeof useAllV3TicksLazyQuery
>;
export type AllV3TicksQueryResult = Apollo.QueryResult<
  AllV3TicksQuery,
  AllV3TicksQueryVariables
>;
...
export function useFeeTierDistributionQuery(
  ...
  return Apollo.useQuery<
    FeeTierDistributionQuery,
    FeeTierDistributionQueryVariables
  >(FeeTierDistributionDocument, options);
}
...
export type FeeTierDistributionQueryHookResult = ReturnType<
  typeof useFeeTierDistributionQuery
>;
