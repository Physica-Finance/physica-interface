...
import META_MANAGER_ABI from 'abis/meta-manager.json'
...
import { MetaManager } from '../types/physica/MetaManager'
...
export function useMetaManagerContract() {
  return useContract<MetaManager>(PLANQ_META_MANAGER_ADDRESS, META_MANAGER_ABI)
}
