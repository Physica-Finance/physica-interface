...
import { CUSD_CELO, DAI_OPTIMISM, USDC_ARBITRUM, USDC_MAINNET, USDC_POLYGON, USDCBSC_PLANQ } from '../constants/tokens'
...
const STABLECOIN_AMOUNT_OUT: { [chainId: number]: CurrencyAmount<Token> } = {
  ...
  [SupportedChainId.PLANQ]: CurrencyAmount.fromRawAmount(USDCBSC_PLANQ, 10_000e6),
}
