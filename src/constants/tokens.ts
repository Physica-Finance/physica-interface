...
function isPLANQ(
  chainId: number
): chainId is SupportedChainId.PLANQ | SupportedChainId.PLANQ {
  return (
    chainId === SupportedChainId.PLANQ || chainId === SupportedChainId.PLANQ
  );
}
