  ...
  const allowance = usePermit2Allowance(
    maximumAmountIn ??
      (parsedAmounts[Field.INPUT]?.currency.isToken
        ...
        : undefined),
    isSupportedChain(chainId) && chainId !== 7070 ? UNIVERSAL_ROUTER_ADDRESS(chainId) : undefined,
  )
                        ...
                        <>
                          <div style={{ height: 20 }}>
                            <MouseoverTooltip
                              text={
                                <Trans>
                                  Permission is required for Physica Financeto swap each token. This will expire after one
