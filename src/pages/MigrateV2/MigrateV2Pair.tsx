        ...
        <AutoColumn gap="lg">
          ...
          {noLiquidity && (
            <BlueCard style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              >
                <Trans>
                  You are the first liquidity provider for this Physica Finance pool. Your liquidity will migrate at the
          ...
          {largePriceDifference ? (
            <YellowCard>
              ...
              <ThemedText.DeprecatedBody fontSize={14} style={{ marginTop: 8, fontWeight: 400 }}>
                <Trans>
                  You should only deposit liquidity into Physica Finance at a price you believe is correct. <br />
