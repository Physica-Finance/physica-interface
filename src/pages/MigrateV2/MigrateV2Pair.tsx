  ...
  return (
    <AutoColumn gap="20px">
      <ThemedText.DeprecatedBody my={9} style={{ fontWeight: 400 }}>
        <Trans>
          This tool will safely migrate your {isNotUniswap ? "SushiSwap" : "V2"}{" "}
        ...
        {chainId && migrator && (
          ...
          >
            <ThemedText.DeprecatedBlue display="inline">
              <Trans>Physica migration contract↗</Trans>
        ...
        <AutoColumn gap="lg">
          ...
          {noLiquidity && (
            ...
            >
              ...
              >
                <Trans>
                  You are the first liquidity provider for this Physica V3 pool.
          ...
          {largePriceDifference ? (
            <YellowCard>
              ...
              >
                <Trans>
                  You should only deposit liquidity into Physica V3 at a price
